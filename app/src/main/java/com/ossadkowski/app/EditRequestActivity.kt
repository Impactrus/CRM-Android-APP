...
import com.ossadkowski.app.data.model.CreateWniosekRequest
import com.ossadkowski.app.data.model.SlownikItemDto
import com.ossadkowski.app.data.model.WniosekDetailDto
import com.ossadkowski.app.ui.editrequest.EditRequestViewModel
import java.io.File
...
class EditRequestActivity : BaseActivity() {
    ...
    private val cameraPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()) { granted ->
        if (granted) showPhotoSourceDialog()
        else Toast.makeText(this, "Brak uprawnień do aparatu", Toast.LENGTH_SHORT).show()
    }
