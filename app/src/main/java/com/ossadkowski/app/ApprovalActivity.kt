...
import com.ossadkowski.app.databinding.ActivityApprovalBinding
import com.ossadkowski.app.ui.approval.ApprovalAdapter
import com.ossadkowski.app.ui.approval.ApprovalViewModel
        ...
        viewModel.approvals.observe(this) { result ->
            ...
            when (result) {
                ...
                is NetworkResult.Success -> {
                    ...
                    binding.pageInfo.text = getString(R.string.page_info_showing, pagination.getShowingStart(), pagination.getShowingEnd(), pagination.totalCount)
