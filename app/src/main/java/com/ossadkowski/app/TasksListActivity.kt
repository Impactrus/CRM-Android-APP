...
import com.ossadkowski.app.databinding.ActivityGenericListBinding
import com.ossadkowski.app.ui.tasks.TasksListViewModel
import com.ossadkowski.app.ui.tasks.TasksV2Adapter
...
class TasksListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.titleText.text = getString(R.string.tasks_title)
