...
import com.ossadkowski.crm.mobile.databinding.ActivityDelegacjeRozliczBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class DelegacjeRozliczActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityDelegacjeRozliczBinding
    private val viewModel: DelegacjeRozliczViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDelegacjeRozliczBinding.inflate(layoutInflater)
        ...
        binding.composeView.apply {
            ...
            setContent { CrmTheme { DelegacjeRozliczScreen(viewModel) } }
        }
    }
