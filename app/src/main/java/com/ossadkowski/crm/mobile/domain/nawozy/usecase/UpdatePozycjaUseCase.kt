...
class UpdatePozycjaUseCase @Inject constructor(
    private val repo: NawozyRepository,
) {
    suspend operator fun invoke(koszykId: Long, lineId: Long, zmiana: EdycjaPozycji): Result<Koszyk> =
        repo.updatePozycja(koszykId, lineId, zmiana)
}
