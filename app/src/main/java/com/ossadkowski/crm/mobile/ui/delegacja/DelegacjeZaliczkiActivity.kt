...
import com.ossadkowski.crm.mobile.databinding.ActivityDelegacjeZaliczkiBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class DelegacjeZaliczkiActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityDelegacjeZaliczkiBinding
    private val viewModel: DelegacjeZaliczkiViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDelegacjeZaliczkiBinding.inflate(layoutInflater)
        setContentView(binding.root)
        initSession()
        setupDrawer(
            drawerLayout = binding.drawerLayout, menuButton = binding.menuButton,
            drawerClose = binding.includeDrawer.drawerClose, drawerName = binding.includeDrawer.drawerName,
            drawerRole = binding.includeDrawer.drawerRole, drawerPanel = binding.includeDrawer.drawerPanel,
            drawerApprovals = binding.includeDrawer.drawerApprovals, drawerTasks = binding.includeDrawer.drawerTasks,
        ...
        binding.composeView.apply {
            ...
            setContent { CrmTheme { DelegacjeZaliczkiScreen(viewModel) } }
        }
    }

    override fun performLogout() {
        sessionManager.clear(); finishAffinity()
