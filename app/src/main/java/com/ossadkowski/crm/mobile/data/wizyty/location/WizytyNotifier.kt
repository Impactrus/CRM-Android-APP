...
class WizytyNotifier @Inject constructor(
    ...
    fun notifyDetectedVisit(contractorName: String?) {
        ...
        val notification = NotificationCompat.Builder(context, NotificationChannelHelper.CHANNEL_ID)
            ...
            .setContentTitle("Potwierdzono wizytę")
            .setContentText("Wykryto wizytę u: $name. Możesz teraz dodać notatkę.")
            .setStyle(NotificationCompat.BigTextStyle().bigText("Zarejestrowano wizytę u: $name. Kliknij, aby dodać notatkę ze spotkania."))
