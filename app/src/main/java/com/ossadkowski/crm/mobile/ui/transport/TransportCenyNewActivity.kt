...
import com.ossadkowski.crm.mobile.databinding.ActivityTransportCenyNewBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class TransportCenyNewActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityTransportCenyNewBinding
    private val viewModel: TransportCenyNewViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTransportCenyNewBinding.inflate(layoutInflater)
