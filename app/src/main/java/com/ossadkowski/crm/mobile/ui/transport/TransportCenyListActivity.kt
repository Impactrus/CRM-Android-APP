...
import com.ossadkowski.crm.mobile.databinding.ActivityTransportCenyListBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class TransportCenyListActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityTransportCenyListBinding
    private val viewModel: TransportCenyListViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTransportCenyListBinding.inflate(layoutInflater)
        ...
        binding.composeView.apply {
            ...
            setContent {
                CrmTheme {
                    TransportCenyListScreen(viewModel = viewModel)
                }
            }
        }
    }
