...
import com.ossadkowski.crm.mobile.databinding.ActivityTransportMapBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class TransportMapActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityTransportMapBinding
    private val viewModel: TransportMapViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTransportMapBinding.inflate(layoutInflater)
        ...
        binding.composeView.apply {
            ...
            setContent {
                CrmTheme {
                    TransportMapScreen(viewModel = viewModel)
                }
            }
        }
    }
