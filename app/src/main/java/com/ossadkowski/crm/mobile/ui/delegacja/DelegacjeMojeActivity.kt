...
import com.ossadkowski.crm.mobile.databinding.ActivityDelegacjeMojeBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class DelegacjeMojeActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityDelegacjeMojeBinding
    private val viewModel: DelegacjeMojeViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDelegacjeMojeBinding.inflate(layoutInflater)
        ...
        binding.composeView.apply {
            ...
            setContent { CrmTheme { DelegacjeMojeScreen(viewModel) } }
        }
    }
