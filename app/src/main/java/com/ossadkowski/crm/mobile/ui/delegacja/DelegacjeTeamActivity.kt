...
import com.ossadkowski.crm.mobile.databinding.ActivityDelegacjeTeamBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class DelegacjeTeamActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityDelegacjeTeamBinding
    private val viewModel: DelegacjeTeamViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDelegacjeTeamBinding.inflate(layoutInflater)
        ...
        binding.composeView.apply {
            ...
            setContent { CrmTheme { DelegacjeTeamScreen(viewModel) } }
        }
    }
