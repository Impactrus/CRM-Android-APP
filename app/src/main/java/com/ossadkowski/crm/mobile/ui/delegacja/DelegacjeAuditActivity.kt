...
import com.ossadkowski.crm.mobile.databinding.ActivityDelegacjeAuditBinding
import com.ossadkowski.crm.mobile.ui.serwis.theme.CrmTheme

class DelegacjeAuditActivity : BaseDrawerActivity() {

    private lateinit var binding: ActivityDelegacjeAuditBinding
    private val viewModel: DelegacjeAuditViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDelegacjeAuditBinding.inflate(layoutInflater)
        ...
        binding.composeView.apply {
            ...
            setContent { CrmTheme { DelegacjeAuditScreen(viewModel) } }
        }
    }
